...
private:
    void test_create_plate_armor_1_mage_9_level()
    {
        ...
        ObjectCreationSummary expected_result = {30,18181.8,4967.53,23149.4,{0.55}};
    ...
    void test_create_plate_armor_1_mage_36_level_roll_is_max_100()
    {
        ...
        ObjectCreator object_creator;
        ObjectCreationSummary expected_result = {17,10000,10928.6,20928.6,{1.0}};
    ...
    void test_create_object_with_cost_not_multiple_of_1000()
    {
        ...
        ObjectCreator object_creator;
        ObjectCreationSummary expected_result = {14,1.81818,2337.66,2339.48,{0.55}};
    ...
    void test_create_object_two_enchantments()
    {
        ...
        ObjectCreator object_creator;
        ObjectCreationSummary expected_result = {36,6000,4821.43,10821.4,{0.5,0.5}};
    ...
    void test_create_object_with_multiple_enchantments()
    {
        ...
        ObjectCreator object_creator;
        ObjectCreationSummary expected_result = {1269,644592,111877,756469,{0.43,0.46,0.43}};
